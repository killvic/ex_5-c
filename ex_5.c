...
void AddNewDictionary(Dictionaries* list) {
...
void AddWordToDictionary(Dictionaries* list) {
...
void DeleteWordFromDictionaty(Dictionaries* list) {
	printf("Chose a dictionary:\n");
	Dictionary* iterator = list->head;
	Word* iterator2 = NULL;
...
void FindWordInDictionary(Dictionaries* list) {
	Dictionary* iterator = list->head;
	...
	while (iteratorDictionary != NULL) {
		if (CompareWords(iteratorDictionary->translations, newWord)) {
...
void DeleteDictionary(Dictionaries* list) {
	Dictionary* iterator = list->head;
